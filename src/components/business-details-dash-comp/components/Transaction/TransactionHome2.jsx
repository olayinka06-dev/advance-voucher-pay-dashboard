...
export default function TransactionHome() {
  ...
  const DropDelete = () => {
    ...
    return (
        <div className="container-fluid bg-[#FFFFFF] py-[20px] px-[30px]">
            <div className="container flex flex-col lg:flex-row">
                <div className="container">
                    <p className="text-[#000000] lg:text-[20px] lg:pb-[0px] pb-[15px] text-[15px] font-[600]">Transaction History</p>
                </div>
                <div className="lg:container relative lg:items-end items-start lg:justify-end justify-start flex space-x-[10px]">
                    <div className=" lg:w-full w-[210px] flex lg:py-[5px] py-[2px] lg:px-[10px] px-[5px] rounded-[10px] border border-[#c6c2c2]">
                        <label htmlFor="search" className="lg:text-[30px] text-[25px] text-[#c6c2c2] cursor-pointer"><BiSearch /></label>
                        <input className="lg:px-[10px] lg:w-full w-[165px] px-[5px] outline-none" type="text" name="search" id="" placeholder="Search Transaction" />
                    </div>
                    <div className="border border-[#c6c2c2] rounded-[10px] lg:py-[7px] py-[2px] lg:px-[10px] px-[5px] space-x-[20px]">
                        <select id="selectOption" className="outline-none ">
                            <option className="lg:text-[15px] text-[10px]" value="option1">Daily</option>
                            <option className="lg:text-[15px] text-[10px]" value="option2">Weekly</option>
                            <option className="lg:text-[15px] text-[10px]" value="option3">Monthly</option>
                            <option className="lg:text-[15px] text-[10px]" value="option3">Yearly</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div className="container lg:w-full w-[800px] bg-[rgba(249,251,252,1)] py-[10px] px-[10px] items-start justify-between flex">
                <p className="text-[rgba(0,0,0,0.5)] text-[14px] font-[600]">Transaction ID</p>
                <p className="text-[rgba(0,0,0,0.5)] text-[14px] font-[600]">Source Acct</p>
                <p className="text-[rgba(0,0,0,0.5)] text-[14px] font-[600]">Destination Acct</p>
                <p className="text-[rgba(0,0,0,0.5)] text-[14px] font-[600]">Amount</p>
                <p></p>
            </div>
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">1</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[12px] text-[#00CCFF] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown}>
                    ...
                    {isDropdownOpen && (
                        <div className=" bg-[#FFFFFF] shadow py-[10px] px-[20px] rounded-[10px] absolute z-20 lg:top-[40%] top-[42%] lg:right-0 right-[35px]">
                            ...
                            <div className="flex space-x-[5px] pt-[15px] pb-[10px] text-[rgba(0,0,0,0.5)]">
                                    ...
                                    <Link href={"/transactions/1"} className="text-[rgba(0,0,0,0.5)] text-[11px]  cursor-pointer">View Details</Link>
                                </div>
                                <div className="flex space-x-[5px] pb-[10px] text-[red]">
                                    <Image height={10} width={10} src="/assets/trash.svg" />
                                    <button className="relative cursor-pointer" onClick={DropDelete}>
                                    ...
                                    {isDropdownDelete && (
                                        <div className="container mx-auto lg:w-[500px] w-[250px] bg-[#FFFFFF] bg-transparent backdrop-blur-[3px] shadow py-[30px] px-[20px] rounded-[10px] absolute z-20 lg:top-[-45%] top-[-70%] lg:right-[250%] right-[80px]">
                                                    <div className="container flex  items-end justify-end">
                                                        <img src="/assets/iconx.svg" className="cursor-pointer" onClick={goBack} />
                                                    </div>
                                                    <p className=" text-black text-center lg:text-[16px] text-[11px] leading-[20px] font-[600]">Are You Sure You Want To <br/> Delete This Content?</p>
                                                    <div className="container mx-auto lg:mt-[40px] mt-[20px] space-x-[20px] items-center justify-center flex">
                                                        <div className="container lg:w-[360px] w-[200px] rounded-[12px]  lg:py-[12px] py-[5px] border border-[rgba(0, 0, 0, 0.1)]">
                                                            <p onClick={goBack} className="text-center cursor-pointer text-[rgba(0,0,0,0.5)] lg:text-[15px] text-[12px] font-[600]">No, Go Back</p>
                                                        </div>
                                                        <div className="container lg:py-[12px] py-[5px] rounded-[12px] cursor-pointer border border-[rgba(254,86,33,1)] bg-[rgba(254,86,33,1)]">
                                                            <p className="text-center text-[white] lg:text-[15px] text-[12px] font-[600]">Yes, Delete It</p>
                                                        </div>
                                                    </div>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">2</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown1}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">3</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown2}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">4</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#FE5621] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown3}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">5</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown4}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">6</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#FE5621] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown5}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">7</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown6}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">8</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown7}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
            ...
            <div className="container lg:w-full w-[800px] border-b-2 items-start py-[10px] px-[10px] justify-between flex">
                    <p className=" text-[rgba(0,0,0,0.5)] text-[12px]"><span className="py-[2px] px-[5px] border border-grey">9</span><span className="ms-[5px]">d3-7ea471789ebe</span></p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">mikexenon23@yahoo.com</p>
                    <p className="text-[rgba(0,0,0,0.5)] text-[12px] ">bartholomew65@gmail.com</p>
                    <p className="text-[#00CCFF] text-[12px] ">+N 20,000</p>
                    <button className=" relative cursor-pointer text-[10px]" onClick={Dropdown8}>
                    <img src="/assets/dots.svg" className="text-[rgba(0,0,0,0.5)]"/>
