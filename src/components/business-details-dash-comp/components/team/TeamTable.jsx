  ...
  let columns = [
    ...
    return (
        <div className="container-fluid bg-[#FFFFFF] py-[20px] px-[30px] rounded-2xl">
            ...
            <p className="text-[20px] font-[600] mb-[20px]">Team Members</p>
              </div>
              <div className="container w-full flex items-end justify-end">
                <Link href={"/teams/teamdetails"} className="text-sm border border-[rgba(0,0,0,0.4)] py-[10px] px-[20px] rounded-[10px] cursor-pointer font-[600] mb-[20px]">+ Invite Team Member</Link>
              </div>
            </div>
