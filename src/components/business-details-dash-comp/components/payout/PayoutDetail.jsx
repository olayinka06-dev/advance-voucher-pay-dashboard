        ...
        <div className="container-fluid bg-[#FFFFFF] p-[48px] px-[50px]">
            ...
            <div className="container lg:mt-[10px] mt-[10px] lg:space-x-[20px] space-x-[10px] flex">
                <div className="container">
                    <label htmlFor="" className="lg:text-sm font-[400] leading-[50px]" >Account Number<span className="text-[red]">*</span></label><br />
                ...
                <div className="container">
                    <label htmlFor="" className="lg:text-sm font-[400] leading-[50px]">Account Name<span className="text-[red]">*</span></label><br />
            ...
            <div className="container mx-auto lg:mt-[20px] mt-[10px]">
                        <label htmlFor="" className="lg:text-sm font-[400] leading-[50px]">Bank Name<span className="text-[red]">*</span></label><br />
            ...
            <div className="container flex flex-col lg:flex-row lg:mt-[20px] mt-[10px] lg:gap-[0] gap-[10px] space-x-[10px]">
                <div className="container w-full">
                    <label htmlFor="" className="lg:text-sm font-[400] leading-[50px]">Enter Amount<span className="text-[red]">*</span></label><br />
                    <div className="flex space-x-[10px] border border-[rgba(0,0,0,0.1)] w-full lg:py-[13px] py-[5px] lg:px-[20px] px-[10px] rounded-[10px] outline-none">
                        ...
                        <select className="outline-none lg:text-[16px] text-[12px] border-r-2" name="" id="">
                ...
                <div className="container w-full">
                    <div className="container">
                        <label htmlFor="" className="lg:text-sm font-[400] leading-[50px]">Description<span className="text-[rgba(0,0,0,0.7)]">(optional)</span></label><br />
                        <input className="border border-[rgba(0,0,0,0.1)] w-full  lg:py-[13px] py-[5px] lg:px-[20px] px-[10px] lg:text-[16px] text-[12px] rounded-[10px] outline-none" placeholder="Jays Alimi" type="text" name="" id="" />
                    </div>
                </div>
