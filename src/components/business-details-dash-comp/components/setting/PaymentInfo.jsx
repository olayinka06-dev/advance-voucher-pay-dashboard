...
export default function SettingPaymentInfo() {
    return (
        <div className="">
            <div className="container mt-[30px]  lg:pb-[80px] pb-[40px] border border-[rgba(0,0,0,0.1)] rounded-[20px]">
            ...
            <div className="container mt-[30px] lg:pt-[55px] pt-[20px] lg:pb-[30px] pb-[15px] border border-[rgba(0,0,0,0.1)] rounded-[20px]">
