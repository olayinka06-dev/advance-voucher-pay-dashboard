      ...
      <form className="mt-7">
        ...
        <div className="flex-col flex gap-5 mb-6  w-full">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="border border-dashed border-[rgba(0,0,0,0.10)] rounded-2xl p-4">
              <div className="py-[90px!important] px-5 bg-[#F9FBFC] flex flex-col items-center justify-center  rounded-xl">
